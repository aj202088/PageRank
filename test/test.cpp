...
//    string expectedOutput = R"(amazon.com 0.00
//bloomberg.com 0.50)";
//
...
//}
//
//// Test with a dangling node
//TEST_CASE("PageRank test 3 with dangling node", "[pagerank]") {
//    string input = R"(4 5
//amazon.com bloomberg.com
//bloomberg.com citadel.com
//citadel.com amazon.com
//dell.com elearning.ufl.edu)";
//    // Node dell.com and elearning.ufl.edu are dangling from rest of graph, so it should receive a fair share of rank
//    string expectedOutput = R"(amazon.com 0.20
//bloomberg.com 0.20
//citadel.com 0.20
//dell.com 0.00
//elearning.ufl.edu 0.00)";
//
//    // Parse input for params
//    int power_iterations;
//    vector<pair<string, string>> edges;
